function [output] = SLD_4_Rascal_with_slab_initiliser(params,bulk_in,bulk_out,contrast)
...
if surface_switch == 1
    [xx,yy] = SLD_sim_and_slab_no_rough(params,bulk_in,bulk_out,contrast,surface_switch)    
