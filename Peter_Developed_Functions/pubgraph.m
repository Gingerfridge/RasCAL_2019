...
function pubgraph(fh,s_x, s_y, x, y)
...
%     YTick = str2double(get(ax,'YTickLabel'));          %get the current Y axis labels
%     XTick = str2double(get(ax,'XTickLabel'));          %get the current X axis labels
