function [SLD_AA_Hydrated_Profile,Output,SL,filenames,Logic_matrix,MATRIX,SLD_AA,OUTPUT,SLD_AA_Profile,OUTPUT_V,Misc_Matrix,Misc_OUTPUT,Misc_OUTPUT_V,V_TOT_AA,V_frac_AA_Hydrated] = SLDfunction(D2O_Frac,box_x,box_y)
...
V_TOT = V_TOT_AA+ Misc_OUTPUT_V(:,3);
...
Check = sum(V_frac_AA_Hydrated,2);
...
SLD_AA_Hydrated_Profile(:,2) = sum(Frac_SLD_Hydrated,2)+Hydraction*PW_SLD;
